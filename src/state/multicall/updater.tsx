...
// 将交换multiCall的gas_limit增大10倍，解决兑换影响率过大问题
export const INPUT_GAS_LIMIT = DEFAULT_CALL_GAS_REQUIRED * 10
export const OUTPUT_GAS_LIMIT = DEFAULT_CALL_GAS_REQUIRED * 10
