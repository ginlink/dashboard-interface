import DEFAULT_TOKEN_LIST from './swap_list.json'
import { TokenList } from 'plugins/@uniswap/token-lists'
...
const TOKEN_LIST: any = DEFAULT_TOKEN_LIST
// getTokenList().then((res) => {
//   TOKEN_LIST = res
// })

// const TRANSFORMED_DEFAULT_TOKEN_LIST = listToTokenMap(TOKEN_LIST)
