...
// import { Tags, TokenInfo } from 'plugins/@uniswap/token-lists'
// import { TokenList } from 'plugins/@uniswap/token-lists/dist/types'
...
// 避免与types/wrappedTokenInfo.ts文件混淆，暂时将此文件改名为111
