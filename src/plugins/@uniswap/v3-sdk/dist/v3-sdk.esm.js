import { MaxUint256, sqrt, Price, CurrencyAmount, Percent, TradeType, Fraction, computePriceImpact, sortedInsert, validateAndParseAddress } from 'plugins/@uniswap/sdk-core';
import JSBI from 'jsbi';
import invariant from 'tiny-invariant';
import { defaultAbiCoder, Interface } from '@ethersproject/abi';
import { getCreate2Address } from '@ethersproject/address';
import { keccak256, pack } from '@ethersproject/solidity';
import { abi as abi$1 } from 'plugins/@uniswap/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json';
import { abi } from 'plugins/@uniswap/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json';
import { abi as abi$2 } from 'plugins/@uniswap/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json';
...
var FACTORY_ADDRESS = isMain ? '0x571521f8c16f3c4eD5f2490f19187bA7A5A3CBDf' : '0x1C7B0F3029B49D90B47a753ce2a4EE77899D8a63';
var ADDRESS_ZERO = '0x0000000000000000000000000000000000000000';
var POOL_INIT_CODE_HASH = '0x8648e6a9f0852d84a8a9787d749989a398cbb000270e4cd106f3dc2bc94e99ff';
/**
...
(function (FeeAmount) {
  FeeAmount[FeeAmount["LOW"] = 1000] = "LOW";
  FeeAmount[FeeAmount["MEDIUM"] = 2000] = "MEDIUM";
  FeeAmount[FeeAmount["HIGH"] = 5000] = "HIGH";
})(FeeAmount || (FeeAmount = {}));
/**
...
var TICK_SPACINGS = (_TICK_SPACINGS = {}, _TICK_SPACINGS[FeeAmount.LOW] = 20, _TICK_SPACINGS[FeeAmount.MEDIUM] = 40, _TICK_SPACINGS[FeeAmount.HIGH] = 100, _TICK_SPACINGS);
...
var NonfungiblePositionManager = /*#__PURE__*/function (_SelfPermit) {
  ...
  NonfungiblePositionManager.encodeCollect = function encodeCollect(options) {
    ...
    if (involvesETH) {
      ...
      calldatas.push(NonfungiblePositionManager.INTERFACE.encodeFunctionData('unwrapWBNB', [toHex(ethAmount), recipient]));
  ...
  NonfungiblePositionManager.removeCallParameters = function removeCallParameters(position, options) {
    ...
    if (options.permit) {
      const presss = NonfungiblePositionManager.INTERFACE.encodeFunctionData('permit', [validateAndParseAddress(options.permit.spender), tokenId, toHex(options.permit.deadline), options.permit.v, options.permit.r, options.permit.s])
      calldatas.push(presss);
    } // remove liquidity
    const removes = NonfungiblePositionManager.INTERFACE.encodeFunctionData('decreaseLiquidity', [{
      tokenId: tokenId,
    ...
    const dasdsd = NonfungiblePositionManager.encodeCollect(_extends({
    ...
    calldatas.push.apply(calldatas, dasdsd);
  ...
  SwapRouter.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    if (routerMustCustody) {
      if (!!options.fee) {
        ...
        calldatas.push(SwapRouter.INTERFACE.encodeFunctionData('unwrapWBNB', [amountOut, recipient]));
      }
    }
