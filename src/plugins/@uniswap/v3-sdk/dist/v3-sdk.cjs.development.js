...
var sdkCore = require('../../sdk-core');
var JSBI = _interopDefault(require('jsbi'));
var invariant = _interopDefault(require('tiny-invariant'));
var abi = require('@ethersproject/abi');
var address = require('@ethersproject/address');
var solidity = require('@ethersproject/solidity');
var NonfungiblePositionManager_json = require('../../v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json');
var ISelfPermit_json = require('../../v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json');
var SwapRouter_json = require('../../v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json');

var contractAddress = require('constants/addresses')
...
// 是否为主网
var isMain = contractAddress.isMain
...
var TICK_SPACINGS = (_TICK_SPACINGS = {}, _TICK_SPACINGS[exports.FeeAmount.LOW] = 20, _TICK_SPACINGS[exports.FeeAmount.MEDIUM] = 40, _TICK_SPACINGS[exports.FeeAmount.HIGH] = 100, _TICK_SPACINGS);
...
function computePoolAddress(_ref) {
  ...
  console.info('POOL_INIT_CODE_HASH===============');
  console.info(POOL_INIT_CODE_HASH);
...
var Pool = /*#__PURE__*/function () {
  ...
  function Pool(tokenA, tokenB, fee, sqrtRatioX96, liquidity, tickCurrent, ticks) {
    ...
    console.log('dsdasdasdsdsdasdssa');
...
var NonfungiblePositionManager = /*#__PURE__*/function (_SelfPermit) {
  ...
  NonfungiblePositionManager.removeCallParameters = function removeCallParameters(position, options) {
    ...
    const ccc = NonfungiblePositionManager.INTERFACE.decodeFunctionData('decreaseLiquidity', removes)
    console.log(ccc);
